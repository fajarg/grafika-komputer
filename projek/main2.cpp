...
//function FOR display information menu
void display1(void)
{

	glClearColor(1.0,1.0,0.1,1.0);
	display_string(40,540,"Fajar Gunawan(1151700010), Andika Ramadhan(1151700004), Alif Rizky(1151700031)",1);
	display_string(320,500,name3,1);
	display_string(330,470,"INFORMATION MENU",2);
